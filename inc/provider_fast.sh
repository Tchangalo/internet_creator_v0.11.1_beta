...
ansible-playbook -i inventories/inventory${provider}.yaml vyos_upgrade_fast.yml "$vyos_ansible_limit"
...
ansible-playbook -i inventories/inventory${provider}.yaml setup_fast.yml "$vyos_ansible_limit"
